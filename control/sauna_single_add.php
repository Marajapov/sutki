...
<div class="main_border">   
            ...
            <div class="clear"></div>
                ...
                <form action="sauna_single_add.php" method="post" enctype="multipart/form-data" name="addnew" id="addnew">
                    <input type="hidden" name="flat_type" value="<?=$flat_type;?>"/>
                    ...
                    <div class="well">
                      ...
                      <select id="capacity" name="capacity" class="priceformedium">
                        ...
                        <option value="15-20 чел">15-20 чел</option>
                        <option value="20-25 чел">20-25 чел</option>
                      </select>                        
                    </div><!--.well--> 
                    <div class="clear"></div> 
                    <div class="well">
                    ...
                    <input type="text" class="pricefor" name="price" value="<?=$price;?>"/> сом
