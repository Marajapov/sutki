...
<div class="main_border"  align="center">   
			...
			<b><?=$rwFlat['name_ru'];?></b><br/><br/>
                    <?php $ds =(strlen($rwFlat['description_ru'])>150) ? substr($rwFlat['description_ru'], 0, 150)." ..." : $rwFlat['description_ru']; ?>
                    <?=nl2br($ds);?>
            </div></div>
            <div class="clear"></div>
            <hr/>
            <div class="clear"></div>
            <div class="rightText"><a href="sauna_rooms_manage.php?flat_id=<?=$flat_id;?>">Добавить номер</a></div>
            <hr/>
            <div class="clear"></div>
            <?php
...
<table width="100%" >
    ...
    foreach ($results as $rw) {
		...
		$ph = count($photosdb)>0?$ph = $photosdb[0]:"";
        ?>
        		 ...
        		 <tr>
                   ...
                   <td>
                    ...
                    <td valign="top">
                   	<a href = "saunaphotos.php?room_id=<?php echo $rw['room_id'];?>">Фотки</a>
					</td>
                    <td valign="top">
                    <a href="sauna_rooms_manage.php?room_id=<?php echo $rw['room_id']; ?>">Редактировать</a>
					</td>
                    <td valign="top">
