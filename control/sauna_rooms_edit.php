...
if (isset($_POST["flat_id"])) {
    ...
    $price_night = (int)$_POST['price_night'];
    $price_day = (int)$_POST['price_day'];
	
	$price_prepay = (int)$_POST['price_prepay'];
    $price_night_prepay = (int)$_POST['price_night_prepay'];
    $price_day_prepay = (int)$_POST['price_day_prepay'];	
	
	$price_universal = ($currency==1)?$price_night*50:$price_night;
	
	$discount = (int)$_POST['discount'];
    $discount_date = $_POST['discount_date'];
	$discount_date_from = $_POST['discount_date_from'];
   ...
   if ($price == "")
        $error.="<b>Цена за час не введен!</b><br>";
    ...
    if ($error == "") {
        ...
        //redirect("sauna_rooms.php?flat_id=".$flat_id, "js");
    }
}
...
$title = "Категории номеров &raquo; <a href='sauna_rooms.php?flat_id=".$flat_id."' style='color:#FFF'>".$flat_name_ru."</a> &raquo; ".$name_ru;
...
Данные успешно сохранены
            ...
            <? } ?>
                ...
                <form action="sauna_rooms_edit.php" method="post" enctype="multipart/form-data" name="addnew" id="addnew">
				  ...
				  <p class="textRed">Параметры номера:</p>
				   ...
				   <p class="textRed">Инвентарь: <font color="#FF0000">*</font></b>(обязательно)</p>
                    <div class="well">                        
                       <?php
                        $rwInv = $db->select("inventory", "flat_type like '0' OR flat_type like '%4%'", "*", "");
