...
<form action="<?php echo $form_action; ?>" method="post" name="addnew" id="addnew">
...
<tr id="list_title">
    ...
    <td width="150" align="center">Дата</td>
    <td align="center">Пароль</td>
    <td align="center">Статус</td>
    <td align="center"></td>
    <td align="center"></td>
    <td width="500" align="center">Объекты</td>
</tr>
<?php

$results = $db->select(DB_PREFIX."users", "user_name <> 'admin'", "*", " ORDER BY user_date DESC, user_id DESC");
...
echo $db->select_count("flats","user_id='".$rw['user_id']."'");
?></td>
<td class="settingstools"><?php echo $rw['user_date']; ?></td>
<td class="settingstools">
<? if ($rw['user_password']==md5("12345")) echo "<b>12345</b>"; else echo "неизвестный";?>
</td>
...
<td class="settingstools">
<?
$flatdb = $db->select("flats","user_id='".$rw['user_id']."'");
foreach($flatdb as $flat){
?>
<a target="_blank" href="http://www.sutki.kg/ru/detail.php?id=<?=$flat['flat_id']?>">
<? if ($flat['city']==1) echo $flat['flat_id']; else {?>
	<font color="#0000FF"><?=$flat['flat_id']?></font>
<? } ?>
</a>&nbsp;&nbsp;
<? } ?>
</td>
