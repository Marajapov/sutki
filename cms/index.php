...
<div class="main_border" align="center">
            ...
            <?php
			$orderby = $mainpage>0?" ORDER BY flat_id desc":" ORDER BY flat_id desc, flat_id desc";
        		 ...
        		 <tr <?=$trstyle;?>>
                   ...
                   <? } ?>
                    ...
                    <td  style="padding:3px">
                        ...
                        <form name="extracounterform<?=$rw['flat_id'];?>" id="extracounterform<?=$rw['flat_id'];?>" action="editextracounterform.php" method="post">
                    	<input name="extracounter" type="text" value="<?php echo $rw['extracounter']; ?>"/>
                        <input type="hidden" name="id" value="<?php echo $rw['flat_id']; ?>" />
                      <input type="submit" name="button" id="button" value="Добавить счетчик" />
                      </form>
