...
<form action="<?php echo $form_action; ?>" method="post" enctype="multipart/form-data" name="addnew" id="addnew">
    <table cellpadding="0" cellspacing="0" border="0" style="height: 30px;">
        <tr>
            <td><input id="btnAddNew" value=" Добавить Инфраструктура " onclick="showDiv('dvForm');" type="button"
    ...
    <div id="dvForm" class="dvForm" style="display: <?php echo $edit ? 'block' : 'none'; ?>;">
        ...
        <table cellspacing="2" cellpadding="2" style="width: 100%;">
            ...
            <tr>
                <td style="text-align: right;">Имя Инфраструктура :</td>
                <td><input size="50" name="name" value="<?php echo $edit ? $infrastructure : ''; ?>"/></td>
            </tr>
        </table>
...
<tr id="list_title">
    <td align="center">Инфраструктура</td>
    <td align="center"></td>
    <td align="center"></td>
</tr>
<?php

$results = $db->select(DB_PREFIX."infrastructure", "user_type < 2", "*", " ORDER BY user_date DESC, user_id DESC");
